...
/// Use this key in the host MaterialApp when Quran notification deep links
/// should open the reader directly.
final quranModuleNavigatorKey = GlobalKey<NavigatorState>();
...
class NotificationTapHandler {
  static Future<void> handle(String? payload) async {
    ...
    quranModuleNavigatorKey.currentState?.push(
