...
class _SelectSurahPageState extends ConsumerState<SelectSurahPage> {
  ...
  Widget _buildSurahItem(
    ...
    return _buildListTileContainer(
      ...
      title: Text(
        SurahNames.getBanglaName(surah.surahNumber),
        style: TextStyle(
          fontSize: 18.sp,
          fontWeight: FontWeight.w700,
          color: context.color.onSurface.withValues(alpha: .95),
        ),
      ),
      subtitle: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        child: SlideAnimation(
                          ...
                          child: FadeInAnimation(
                            child: _buildJuzItem(
                              context,
                              data[index].id,
                              SurahNames.getBanglaName(pageNumber),
  ...
  Widget _buildNumberIndicator(BuildContext context, int number, bool isDark) {
    return Stack(
      ...
      children: [
        ...
        Text(
          SurahNames.toBanglaNumber(number),
          style: TextStyle(
            fontSize: 12.sp,
            fontWeight: FontWeight.bold,
